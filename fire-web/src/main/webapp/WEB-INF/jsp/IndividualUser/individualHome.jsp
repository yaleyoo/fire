		...
		<div class="banner-agileinfo">
			...
			<div class="">
				<div class="container">
					<div class="logo">
						<h1>
							<a href="index.html">Fes Booking</a>
						</h1>
					</div>
						...
						<section id="container">
							...
							<section id="main-content">
									...
									<div class="row mt">
										...
										<aside class="col-lg-3 mt">
											...
											<div id="external-events">
												<!--<div class="external-event label label-theme">My Event</div>
	                          ...
	                          <div class="external-event label label-success">My Event 9</div>-->
												...
												<div class="external-event label label-success">Enrolled
													Class</div>

												<div class="external-event label label-danger">Resent
													Class</div>
												<div class="external-event label label-default">Passed
													Class</div>
												<div class="external-event label label-warning">Personal
													Event</div>
												<p class="drop-after">
									...
									<div class="content-panel">
										<table class="table table-striped table-advance table-hover">
											<div class="qian_right">
												<h4>
													<i class="fa fa-angle-right" href="history.html"></i> <a
														href="individual_orderhistory.html">
											...
											<thead>
												<tr>
													...
													<th class="hidden-phone"><i
														class="fa fa-question-circle"></i> Descrition</th>
											...
											<tbody>
												...
												<tr>
													<td><a href="basic_table.html#"> 3 </a></td>
													<td class="hidden-phone">XXX</td>
													<td>10000.00$</td>
													<td><span class="label label-warning label-mini">Paid</span></td>
													<td>
												...
												<tr>
													<td><a href="basic_table.html#"> 4 </a></td>
													<td class="hidden-phone">XXX</td>
													<td>10000.00$</td>
													<td><span class="label label-warning label-mini">Paid</span></td>
													<td>
				...
				<div class="grid_3 grid_5 ">
					<div class="showback">
						...
						<div class="alert alert-info" role="alert">
							...
							<ol class="breadcrumb">
								<li class="active">Contect number</li>
								<li class="active">Contect number</li>
							</ol>
							<ol class="breadcrumb">
							...
							<a href="Individual_profile.html">
								<button type="button" class="btn btn-theme" href="profile.html">
		...
		<div class="footer-agiletop">
			<div class="container">
				...
				<div class="col-md-4 w3agile_hire_right">
					...
					<a href="mail.html" class="wthree-more w3more1 nina"
