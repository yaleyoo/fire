...
<html lang="en">
<head>
<title>Organization ChildrenAccounts</title>
...
<body> 
	...
	<div class="codes">
		<div class="container"> 	
			...
			<div class="showback">
				<div class="w3ls-title">
				<h3 class="agileits-title">Children Account Register</h3> </div>
					...
					<div class="tab-pane active" id="horizontal-form">
						<form class="form-horizontal" name="form1">
							...
							<div class="form-group">
								...
								Family Name<span style="color:red">*</span></label>
								<div class="col-sm-8">
									<input type="text" class="form-control1" id="familyName" placeholder="">
									<span class="FnameInfo"></span>
								</div>
							</div>
							<div class="form-group">
								<label for="focusedinput" class="col-sm-2 control-label">Email Address<span style="color:red">*</span></label>
								<div class="col-sm-8">
									
									<div class="form-control_userName">
									<input type="text" class="form-control_userName_input" id="userName" placeholder="">
									
									<input type="button" class="button white" value="Get the CAPTCHA" onclick="settime(this)" />
									</div>

									<input type="text" class="form-control_userName_Captcha" id="userName" placeholder="">
							...
							<div class="form-group">
								<label for="inputPassword" class="col-sm-2 control-label" >Confirm Password<span style="color:red">*</span></label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								<label for="focusedinput" class="col-sm-2 control-label">Contect Number<span style="color:red">*</span></label>
								<div class="col-sm-8">
									<input type="text" class="form-control1" id="contectNumber" placeholder="">
									<span class="contectInfo"></span>
								</div>
							</div>
							...
							<div class="form_register">
								...
								<a href="mail.html" class="wthree-more w3more1 nina" data-text="Register"> 
  ...
  <head>	
	...
	window.onload=function() {
		...
		Fname.onblur=function(){
			...
			if(this.value==""){
				FnameInfo.innerHTML='<i class="cuo"></i> please enter your family name';
			}else{
				FnameInfo.innerHTML='<i class="right"></i> OK';
			}
		}
		...
		userName.onblur=function(){
			var m=findStr(this.value,this.value[0]);
			if(this.value==""){
				userNameInfo.innerHTML='<i class="cuo"></i> please enter your email address';
			}else{
				userNameInfo.innerHTML='<i class="right"></i> OK';
			}
		}
	...
	ctNum.onblur=function(){
			var m=findStr(this.value,this.value[0]);
			if(this.value==""){
				contectInfo.innerHTML='<i class="cuo"></i> please enter your family name';
			}else{
				contectInfo.innerHTML='<i class="right"></i> OK';
			}
		}
