	...
	<div class="banner jarallax">
		<div class="banner-agileinfo">
			...
			<div  class="banner-w3lstext agileits-w3layouts">  
				<ol class="breadcrumb">
					<li><a href="organization_home.html">Homepage</a></li> 
					...
					<div class="tab-pane active" id="horizontal-form">
						<form class="form-horizontal" name="form1">
							...
							<div class="form-group">
								<label for="focusedinput" class="col-sm-2 control-label">Organization Name</label>
								<div class="col-sm-8">
									<input type="text" class="form-control1" id="Organization Name" placeholder="Organization Name"/>
								</div>
							</div>
							...
							<div class="form_register">
								...
								<a href="mail.html" class="wthree-more w3more1 nina" data-text="Submit"> 
