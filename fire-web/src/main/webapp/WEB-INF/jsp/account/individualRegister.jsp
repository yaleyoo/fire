...
<body onload="individualRegisterVerification()">
	<!-- banner -->
	...
	<div class="codes">
		<div class="container">
			<div class="w3ls-title">
				<h3 class="agileits-title">Indivudual customer Register</h3>
			</div>
			<div class="grid_3 grid_4">
				<!--<h3 class="w3ls-hdg">Horizontal Form</h3>-->
				<div class="tab-content">
					<div class="tab-pane active" id="horizontal-form">
						<form class="form-horizontal" name="individualRegisterForm"
							id="individualRegisterForm" action="post">
							...
							<div class="form_register">
								...
								<br>
								<a class="wthree-more w3more1 nina"
									data-text="Register" id="submit" 
									onclick="individualRegisterRequest()"> <span>R</span><span>e</span><span>g</span><span>i</span><span>s</span><span>t</span><span>e</span><span>r</span>
								</a>
							</div>
						</form>
					</div>
